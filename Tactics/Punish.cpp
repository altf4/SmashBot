...
void Punish::DetermineChain()
{
    ...
    double enemyHitSlide = m_state->calculateSlideDistance((CHARACTER)m_state->m_memory->player_one_character,
    ...
    Logger::Instance()->Log(INFO, "selfSlide: " + std::to_string(selfSlide));
    Logger::Instance()->Log(INFO, "enemyHitSlide: " + std::to_string(enemyHitSlide));
    Logger::Instance()->Log(INFO, "frames_left: " + std::to_string(frames_left));
    Logger::Instance()->Log(INFO, "player_two_speed_ground_x_self: " + std::to_string(m_state->m_memory->player_two_speed_ground_x_self));
